        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EnabledAfter = table.Column<DateTime>(type: "TEXT", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Version = table.Column<Guid>(type: "BLOB", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    ForumSectionId = table.Column<int>(type: "INTEGER", nullable: false),
                    IsActive = table.Column<bool>(type: "INTEGER", nullable: false),
                    Slug = table.Column<string>(type: "TEXT", maxLength: 35, nullable: false),
                    Subtitle = table.Column<string>(type: "TEXT", maxLength: 85, nullable: true),
                    Title = table.Column<string>(type: "TEXT", maxLength: 35, nullable: false),
                    Version = table.Column<Guid>(type: "BLOB", nullable: false)
                },
                constraints: table =>
