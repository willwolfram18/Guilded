...
namespace SelamaApi.Tests.Data.DAL.Home
{
    public class GuildActivityReadOnlyDataContextUnitTest
    {
        ...
        private readonly Mock<IReadOnlyRepository<SelamaApi.Data.Models.Home.GuildActivity>> _mockGuildNewsRepo = new Mock<IReadOnlyRepository<SelamaApi.Data.Models.Home.GuildActivity>>();
        private readonly List<GuildNews> _battleNetNews = new List<GuildNews>();
        private readonly List<SelamaApi.Data.Models.Home.GuildActivity> _websiteNews = new List<SelamaApi.Data.Models.Home.GuildActivity>();
        #endregion
        #endregion
        ...
        public async Task PageNumLessThanOneAlwaysGivesEmptyList(bool isEmptyNews, bool isMember)
        {
            ...
            #region Act
            List<SelamaApi.Data.ViewModels.Home.GuildActivity> result = null;
            if (isMember)
            {
            ...
            #region Assert
            AssertResultMatchesExpected(result, new List<SelamaApi.Data.ViewModels.Home.GuildActivity>());
            #endregion
        }
        ...
        public async Task GetPublicGuildNewsAsync_EmptyPublicNewsGivesEmptyList(int pageNum)
        {
            ...
            #region Act
            List<SelamaApi.Data.ViewModels.Home.GuildActivity> result = await _dataContext.GetPublicGuildNewsAsync(pageNum, PAGE_SIZE);
            #endregion
        ...
        {
            #region Arrange
            List<SelamaApi.Data.ViewModels.Home.GuildActivity> expectedNews = _battleNetNews
                .ToListOfDifferentType(SelamaApi.Data.ViewModels.Home.GuildActivity.CreateFromBattleNetNews);
            expectedNews.Sort();
        ...
        public async Task GetMembersOnlyNewsAsync_EmptyMembersNewsGivesEmptyList(int pageNum)
        {
            ...
            #region Act
            List<SelamaApi.Data.ViewModels.Home.GuildActivity> result = await _dataContext.GetMembersOnlyNewsAsync(pageNum, PAGE_SIZE);
            #endregion
            ...
            List<SelamaApi.Data.ViewModels.Home.GuildActivity> expectedNews = _battleNetNews
                ...
                .Concat(
                    _websiteNews.ToListOfDifferentType(n =>
                        new SelamaApi.Data.ViewModels.Home.GuildActivity(n.Timestamp, n.Content)
                    )
                )
                .ToList();
            expectedNews.Sort();
        ...
        private void InitializeGuildNewsRepo()
        {
            ...
            _mockGuildNewsRepo.Setup(r =>
                r.Get(
                    It.IsAny<Func<IQueryable<SelamaApi.Data.Models.Home.GuildActivity>, IOrderedQueryable<SelamaApi.Data.Models.Home.GuildActivity>>>()
                )
            ).Returns(
        ...
        private void CreateWebsiteNews()
        {
            for (int i = NUM_WEBSITE_NEWS_ENTRIES - 1; i >= 0; i--)
            {
                ...
                _websiteNews.Add(new SelamaApi.Data.Models.Home.GuildActivity
                {
                    Id = adjustedIndex + 1,
        ...
        private void AssertResultMatchesExpected(List<SelamaApi.Data.ViewModels.Home.GuildActivity> result, List<SelamaApi.Data.ViewModels.Home.GuildActivity> expected)
        {
