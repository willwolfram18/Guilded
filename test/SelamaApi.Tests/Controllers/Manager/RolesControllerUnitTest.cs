...
using SelamaApi.Controllers.Manager;
using SelamaApi.Data;
using SelamaApi.Data.Models.Core;

using ViewModel = SelamaApi.Data.ViewModels.Core.ApplicationRole;
using DataModel = SelamaApi.Data.Models.Core.ApplicationRole;
using SelamaApi.Extensions;
using Microsoft.AspNetCore.Mvc;
using Xunit;
using SelamaApi.Data.ViewModels.Core;

namespace SelamaApi.Tests.Controllers.Manager
{
